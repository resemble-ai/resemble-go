...
type Recording interface {
	// All returns all recording by given page and pagesize
	All(uuid string, page int, pageSize ...int) (response.Recordings, error)
	...
	// Get returns recording by given voice uuid
	Get(voiceuuid, uuid string) (response.Recording, error)

	// Update update recording by given voice uuid
